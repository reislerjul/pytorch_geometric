...
class ArgsInit(object):
    def __init__(self):
        ...
        parser.add_argument('--model_load_path', type=str,
                            default='ogbn_arxiv_pretrained_model.pth',
    ...
    def save_exp(self):
        ...
        self.args.save = ('{}-B_{}-C_{}-L_{}-F_{}-DP_{}'
                          ...
                          '-MN_{}-LS_{}'.format(
                              ...
                              self.args.t, self.args.learn_t, self.args.p,
                              self.args.learn_p, self.args.msg_norm,
